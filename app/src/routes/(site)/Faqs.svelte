<script lang="ts">
	...
	const faqs = [
		...
		},
		{
			...
			description:
				'The answer is it is minimial and user centric you don\'t have to think about a lot, "just make and publish"'
		},
		{
			title: 'How to use?',
...
<div
	id="faqs"
	class="mx-auto max-w-5xl select-none px-6 py-8 sm:py-12 lg:px-8 lg:py-16 dark:bg-stone-950"
>
